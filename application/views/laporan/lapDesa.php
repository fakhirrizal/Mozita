    ...
    <div class="col-md-12">
        <table id="table" class="table table-bordered"style="font-size:10px; color:#000000; font-weight:500; width:100%">
            ...
            <tr>
                ...
                <th class="text-left" colspan="18" style="padding-bottom: 0px;">: <?= $nama_propinsi ?></th>
            </tr>
            <tr>
                <th class="text-left" colspan="2" style="padding-bottom: 0px;">KABUPATEN</th>
                <th class="text-left" colspan="18" style="padding-bottom: 0px;">: <?= $kabupaten ?></th>
            </tr>
            <tr>
                <th class="text-left" colspan="2" style="padding-bottom: 0px;">KECAMATAN</th>
                <th class="text-left" colspan="18" style="padding-bottom: 0px;">: <?= $kecamatan ?></th>
            </tr>
            <tr>
                <th class="text-left" colspan="2" style="padding-bottom: 0px;">DESA</th>
                <th class="text-left" colspan="18" style="padding-bottom: 0px;">: <?= $desa ?></th>
            </tr>
            <tr>
                <th class="text-left" colspan="2" style="padding-bottom: 0px;">PUSKESMAS</th>
                <th class="text-left" colspan="18" style="padding-bottom: 0px;">: <?= $puskesmas ?></th>
            </tr>
            <tr>
                <th class="text-left" colspan="2" style="padding-bottom: 0px;">JUMLAH BALITA GAKIN</th>
                <th class="text-left" colspan="18" style="padding-bottom: 0px;">: <?= $jmlBalitaGakin ?></th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-center" rowspan="4">POSYANDU</td>
            ...
            ?>
                <tr>
                    ...
                    <td><?= $rows->namapos ?></td>
                    <td class="text-center"><?= $jml_balita_aktif_laki_laki + $jml_balita_aktif_perempuan ?> </td>
                    <td class="text-center"><?= $jml_balita_timbang_laki_laki + $jml_balita_timbang_perempuan ?></td>
