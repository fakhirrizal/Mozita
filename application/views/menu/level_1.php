...
<li> 
    <a href="<?= site_url() ?>/data-posyandu" class="waves-effect waves-dark <?= ((isset($menu) && $menu == "Data Posyandu" )? "active":"") ?>" aria-expanded="false">
        <i class="mdi mdi-hospital"></i>
        <span class="hide-menu">Data Posyandu</span>
    </a>
</li>
<li> 
    <a href="<?= site_url() ?>/data-user" class="waves-effect waves-dark" aria-expanded="false">
        <i class="mdi mdi-account-multiple"></i>
        <span class="hide-menu">Data Pengguna</span>
    </a>
</li>
<li> 
    <a href="<?= site_url() ?>/data-balita" class="waves-effect waves-dark <?= ((isset($menu) && $menu == "Data Balita" )? "active":"") ?>" aria-expanded="false">
        <i class="mdi mdi-human-child"></i>
        <span class="hide-menu">Data Balita</span>
    </a>
</li>
<li> 
    <a href="<?= site_url() ?>/penimbangan" class="waves-effect waves-dark <?= ((isset($menu) && $menu == "Penimbangan" )? "active":"") ?>" aria-expanded="false">
        <i class="mdi mdi-gauge"></i>
        <span class="hide-menu">Penimbangan</span>
    </a>
</li>
<li>
